...
class ProteomicsLFQ_command:
    ...
    def file_path_mzTab():
        try:
            open('/Users/Alex/Desktop/TeamProjekt-ganzes-Team/src/FRACTIONS/BSA.mzTab.tmp')
            path = '/Users/Alex/Desktop/TeamProjekt-ganzes-Team/src/FRACTIONS/BSA.mzTab.tmp'
            return path
        except: 
            return "error"
