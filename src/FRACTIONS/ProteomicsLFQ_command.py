...
class ProteomicsLFQ_command:
    ...
    def run_console_ProteomicsLFQ():
        ...
        os.chdir("/home/caro/Documents/2.Semester/TeamProjekt/Teamprojekt/src/FRACTIONS")
    ...
    def file_path_mzTab():
        try:
            open('/home/caro/Documents/2.Semester/TeamProjekt/Teamprojekt/src/FRACTIONS/BSA.mzTab.tmp')
            path = '/home/caro/Documents/2.Semester/TeamProjekt/Teamprojekt/src/FRACTIONS/BSA.mzTab.tmp'
            return path
        except:
            return "error"
