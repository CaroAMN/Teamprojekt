...
MzMLFile().load("../data/YIC(Carbamidomethyl)DNQDTISSK.mzML", exp)  # noqa: F405, E501
...
tsg.setParameters(p)
tsg.getSpectrum(
    theo_spectrum, AASequence.fromString("YIC(Carbamidomethyl)DNQDTISSK"), 1, 2  # noqa: F405, E501
)
